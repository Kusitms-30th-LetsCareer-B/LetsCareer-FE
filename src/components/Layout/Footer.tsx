            ...
            <div className="flex flex-col gap-[3.25rem] lg:justify-between lg:gap-7">
                <div className="flex flex-col gap-[3.25rem] lg:flex-row-reverse lg:justify-between">
                    <div className="flex flex-col gap-[3.25rem] lg:flex-row lg:items-start lg:gap-[6.25rem]">
                        <div className="flex flex-col gap-3">
                            <a className="text-0.875-medium w-fit" href="/about">렛츠커리어 스토리</a>
                            <a className="text-0.875-medium w-fit" href="/program">프로그램</a>
                            <a className="text-0.875-medium w-fit" href="/blog/list">블로그</a>
                        </div>
                        <div className="flex flex-col gap-3">
                            <a className="text-0.875-medium w-fit notice_cta" rel="noopener noreferrer" href="https://letscareer.oopy.io" target="_blank">공지사항</a>
                            <a className="text-0.875-medium w-fit inquiry_cta" rel="noopener noreferrer" href="https://docs.google.com/forms/d/e/1FAIpQLSeHM_d3yd0cOiH2aSqhprtSFmidIYFziyIxf5-9j7rgZCobvA/viewform" target="_blank">광고/제휴 문의</a>
                            <a className="text-0.875-medium w-fit q&amp;a_cta" rel="noopener noreferrer" href="https://letscareer.oopy.io" target="_blank">자주 묻는 질문</a>
                ...
                <div className="flex items-center justify-between lg:justify-start lg:gap-5">
                    <div className="flex items-center gap-4">
                        <a rel="noopener noreferrer" className="instagram_cta" href="https://www.instagram.com/letscareer.official/" target="_blank">
                            <img className="w-5" src={instagram} alt="인스타그램 아이콘"></img>
                        </a>
                        <a rel="noopener noreferrer" className="blog_cta" href="https://blog.naver.com/PostList.naver?blogId=letsintern" target="_blank">
                            <img className="w-5" src={blog} alt="네이버 블로그 아이콘"></img>
                        </a>
                    </div>
                    <div className="flex items-center gap-6 text-neutral-0/[.65]">
                        <a className="text-0.75-medium lg:text-0.875-medium" rel="noopener noreferrer" href="https://letscareer.oopy.io/a121a038-f72f-42d7-bde7-47624ecc0943" target="_blank">서비스 이용약관</a>
                        <a className="text-0.75-medium lg:text-0.875-medium" rel="noopener noreferrer" href="https://letscareer.oopy.io/c3af485b-fced-49ab-9601-f2d7bf07657d" target="_blank">개인정보처리방침</a>
                    </div>
                </div>
            </div>
