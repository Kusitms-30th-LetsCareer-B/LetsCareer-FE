  ...
  return (
    ...
    <div className="font-sans rounded-lg border border-neutral-90 shadow-xl w-[360px]"> {/* width를 360px로 고정함. w-[360px] 삭제하면 반응형으로 됨 */}
      ...
      <div className="flex justify-end px-5 py-3"> {/*아이템들을 선형으로 우측 정렬*/}
        {/* 취소 버튼 */}
        <div onClick={onCancel} className="text-xsmall14 text-neutral-40 px-7 rounded-lg hover:text-primary-100">
          취소
        </div>

        {/* 선택완료 버튼 */}
        <div onClick={handleConfirmSelection} className="text-xsmall14 text-neutral-40 rounded-lg hover:text-primary-100">
          선택완료
        </div>
        <br/>
      </div>
