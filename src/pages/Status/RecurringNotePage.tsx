...
const handleSave = async () => {
    ...
    try {
        const response = await axios.put(`${BASE_URL}/reviews/save?recruitmentId=${recruitmentId}`, requestBody);
    ...
    return (
        <div className="w-[1128px] mb-[100px] mx-[48px] mt-[40px]">
            ...
            <div className="flex items-start gap-[20px]">
                <DocumentRecurringNoteLeftPart documentData={documentData} setDocumentData={setDocumentData}/>
