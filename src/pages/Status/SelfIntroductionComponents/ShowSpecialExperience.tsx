import { ColoredExperienceChip, ExperienceBlackChip } from "../components/Chips/SelfIntroductionChip";
...
interface ShowExperienceProps {
  ...
  export const ShowExperience = ({tabType, title, content}: ShowExperienceProps) => {
    return (
