...
import {
  SelectExperienceBlackButton,
  SelectExperienceDeepButton,
  SelectExperienceLightButton,
} from "../components/Buttons/SelfIntroduceButton";
...
export const GetExperience: React.FC<GetExperienceProps> = ({
  onSelectExperience,
  onTabChange,
}) => {
