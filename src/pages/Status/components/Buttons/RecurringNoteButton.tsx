...
const BadButton = ({ isSelected, onClick }: { isSelected: boolean, onClick: () => void }) => {
    return (
        <button 
        onClick={onClick} 
        className={`flex w-[92px] items-center border border-neutral-80 bg-neutral-100 rounded-sm px-[10px] py-[6px] mr-[6px] ${isSelected ? 'bg-primary-10 text-primary border-primary' : 'bg-neutral-90 text-neutral-45'}`}>
