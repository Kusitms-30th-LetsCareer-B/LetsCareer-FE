import { useInterviewPagination } from "../../../../shared/hooks/useInterviewPagination";
...
export const SelfIntroductionQuestions = ({
  ...
  const {
    ...
    handleNextClick,
    getVisiblePages,
  } = useInterviewPagination(totalItems, itemsPerPage, initialPage, onPageChange);
  ...
  return (
    <div className="flex items-center gap-[4px]">
      ...
      <button
        ...
        className="flex h-[28px] w-[70px] flex-shrink-0 flex-col items-center justify-center rounded-lg border border-neutral-80 bg-static-100"
      >
