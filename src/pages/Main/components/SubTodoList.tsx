...
const SubTodoList = () => {
  ...
  const { useCountIncomplete, useTotalCountIncomplete } = useTodoCounting();
    ...
    <div className="w-[247px] rounded-lg border border-neutral-80 font-sans">
      ...
      <div className="flex items-center justify-between py-5">
        ...
        <div className="flex-shrink-0 px-5">
          {" "}
          {/* 이미지 크기를 고정하고 여백을 추가하지 않음 */}
          <img src={todoListIcon} alt="Todo List Icon" />
        </div>

        {/* 텍스트 섹션 */}
        <div className="flex flex-row px-5 font-semibold">
          {" "}
          {/* flex-row로 가로 정렬 및 간격 설정 */}
          <div className="flex flex-col">
            ...
            <div className="flex items-end">
              ...
              {/* 전체 스케줄 개수 표시 */}
              <span className="px-2 text-xsmall16 text-neutral-60">
                / {companies.length}개
              </span>
            </div>
          </div>
