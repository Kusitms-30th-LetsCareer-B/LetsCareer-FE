...
import {
  ...
  GetRequestMainTodayType,
} from "../api/mainTodayType.ts";
...
const sampleCompanies = [
  {
    id: 1,
    name: "네이버",
    schedules: ["면접 준비", "서류 제출"],
    completed: [false, true],
  },
  {
    id: 2,
    name: "카카오",
    schedules: ["코딩 테스트", "최종 발표"],
...
const MainTodoList = ({
  ...
  return (
    /* 컴포넌트 전체 윤곽 컨테이너 스타일 */
    <div className="w-[247px] rounded-lg border border-neutral-80 font-sans">
      {" "}
                ...
                return (
                  <>
                    ...
                    >
                      ...
                      <img
                        src={imageSrc}
                        alt={`Schedule status for ${schedule}`}
