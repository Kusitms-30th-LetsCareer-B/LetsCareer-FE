...
// 상태 칩스 7종
import { PrepareDocumentChip, PassDocumentChip, PrepareInterviewChip, 
  PassInterviewChip, JobTestChip } from "../../../components/chips/StatusChip";
  ...
  */
  ...
  useEffect(() => {
    ...
    const samples: Career[] = [
      { id: 1, remainingDays: 9, deadline: '2024-10-15', companyName: '네이버', position: '개발자', status: 0 },
      { id: 2, remainingDays: 10, deadline: '2024-10-22', companyName: '카카오', position: '디자이너', status: 1 },
      { id: 3, remainingDays: 17, deadline: '2024-10-13', companyName: '삼성전자', position: '마케팅', status: 2 },
      { id: 4, remainingDays: 19, deadline: '2024-10-17', companyName: 'LG', position: '기획자', status: 3 },
      { id: 5, remainingDays: 29, deadline: '2024-10-11', companyName: '현대차', position: '엔지니어', status: 4 },
      { id: 6, remainingDays: 40, deadline: '2024-10-20', companyName: 'SK', position: '관리자', status: 4 },
      { id: 7, remainingDays: 42, deadline: '2024-10-12', companyName: '롯데', position: '회계사', status: 3 },
    ];
  ...
  return (
    <div className="p-4 max-w-2xl mx-auto">
      ...
      {careerList.slice(0, visibleCareers).map((career, index) => (
        ...
        >
          <div className='flex px-2 gap-2'><Ddayh24Chip day={career.remainingDays} /> {career.deadline}</div>
