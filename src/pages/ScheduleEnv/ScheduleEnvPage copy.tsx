...
const ScheduleEnvPage = () => {
  ...
  return (
    <div className="rounded-sm bg-static-100 p-10">
      ...
      >
        {/** 1. 기업명 */}
        <div className="flex items-center justify-start text-center text-small18 font-semibold text-neutral-30">
          {/* 라벨 */}
        ...
        <div className="flex items-center justify-start text-center text-small18 font-semibold text-neutral-30">
          ...
          <div className="flex px-5 text-xsmall16 font-medium text-neutral-45">
            ...
            <div className="px-4">관심기업으로 등록하기</div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-start text-center text-small18 font-semibold text-neutral-30">
          {/* 시작일 */}
          <div className="font-regular flex min-w-[248px] justify-between rounded-xs border border-neutral-80 p-5 text-start text-xsmall16 text-neutral-45">
          ...
          <div className="px-5 text-center">~</div>
        ...
        {/** 4. 마감일 리마인드 */}
        <div className="flex items-center justify-start text-center text-small18 font-semibold text-neutral-30"></div>
        <div className="flex items-center justify-start text-center text-small18 font-semibold text-neutral-30">
          {/* 선택 버튼 */}
