/* ToDo 관련 Tools 임포트 */
import { PersonalScheduleListProps, TodoListProps, formatDate1 } from "../../../components/ToDoListTool.ts"
/* 로그인 정보 받기 */
...
const CalendarList = ({selectedDate, setSelectedDate, userId, userName} : CombinedProps) => {
    ...
    /* 컴포넌트 렌더링 */
    return (
        <div className="font-sans rounded-lg border border-neutral-80 w-[247px] px-5 ">
            {/** 채용 일정 */}
             ...
             */}
            <Test userId={userId} userName={userName} selectedDate={selectedDate} setSelectedDate={setSelectedDate}/>
