...
interface CalendarCareerListProps
  extends userInfo,
...
/** 컴포넌트 */
const CalendarCareerList = ({
  userId,
  userName,
  selectedDate,
  setSelectedDate,
  recruitmentScheduleChips,
}: CalendarCareerListProps) => {
  // 커스텀 캘린더 훅에서 필요한 상태와 핸들러 가져오기
  const { handleNewSchedule } = useCalendar();
  ...
  return (
    <>
      {/* 첫 번째 파트: 타이틀 */}
      <div className="py-1 text-xsmall14 text-neutral-30">채용 일정</div>
