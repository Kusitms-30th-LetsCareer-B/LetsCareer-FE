...
// API 연동 타입
import { TodoDayGroupedByCompany_URL, GetParamsTodoDayGroupedByCompanyType } from "./todoDayGroupedByCompanyType.ts"


/** 조회 */
// GET 요청 및 응답받기 (백엔드와 API 연동)
export const getResponseTodoDayGroupedByCompany = async ({ userId, date }: GetParamsTodoDayGroupedByCompanyType) => {
  try {
